...
public class FileService {
    ...
    public void addDatafromCsvFile(MultipartFile file, Transaction transaction) throws FileUploadException {
        ...
        try {
            ...
            throw new FileUploadException("Ha ocurrido un error con el archivo");
        }
    }
}
